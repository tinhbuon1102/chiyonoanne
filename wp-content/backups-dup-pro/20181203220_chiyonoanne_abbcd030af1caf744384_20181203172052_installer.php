...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181203220_chiyonoanne_abbcd030af1caf744384_20181203172052_archive.zip';
	const ARCHIVE_SIZE		 = '729883438';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'abbcd03-03172052';
	const VERSION			 = '3.7.9';
