...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181203_chiyonoanne_c67d98b0cfd7e6dc5759_20181203071930_archive.zip';
	const ARCHIVE_SIZE		 = '724850459';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c67d98b-03071930';
	const VERSION			 = '3.7.9';
