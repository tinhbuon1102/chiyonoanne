/*
 * Custom WooCommerce Variation Swatches Pro v1.0.27 
 * 
                ...
                /******/([
                    ...
                    /***/ (function (module, exports) {
                        ...
                        (function ($, window, document, undefined) {
                            ...
                            /**
                             * When a variation is shown. changed
                             */

                            function isPassRequired() {
                            ...
                            VariationForm.prototype.onShow = function (event, variation, purchasable) {
                                ...
                                if ($('.ywapo_options_container').length) {
                                    //var selectedwapo = $('#yith_wapo_groups_container').find('.ywapo_selected').length >= $('#yith_wapo_groups_container').find('abbr.required').length;// It not enought
                                    if (purchasable && isPassRequired()) {
