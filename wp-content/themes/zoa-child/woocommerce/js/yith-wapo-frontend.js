/**
 * Custom yith-woocommerce-advanced-product-options-premium plugin
 * Frontend
 * 
...
//Enable & Disable add-to-card-button for group options
        function isPass() {
            var abbr_required_pdp = $('.pdp__attribute--group').find('abbr.required').length;
            var selected_pdp = $('.pdp__attribute--group').find('.selected').length;
            var selected_ywapo = 0;// $('#yith_wapo_groups_container').find('.ywapo_selected').length;
            var abbr_required_ywapo = 0;// $('#yith_wapo_groups_container').find('abbr.required').length;
            $('.yith_wapo_groups_container').find('.ywapo_group_container').each(function () {
                if ($(this).hasClass('ywapo_conditional_hidden')) {

                } else {
                    selected_ywapo += $(this).find('.ywapo_selected').length;
                    abbr_required_ywapo += $(this).find('abbr.required').length;
                }
            });
            console.log('selected-required:' + selected_ywapo + '-' + abbr_required_ywapo);
            if (selected_pdp >= abbr_required_pdp && selected_ywapo >= abbr_required_ywapo) {
                return true;
            } else {
                return false;
            }
        ...
        //For radio
        $(this).on('click', '.ywapo_input_container.ywapo_input_container_radio', function (e) {
            'use strict';
            $('.ywapo_input_container.ywapo_input_container_radio').removeClass('ywapo_selected');
            $(this).addClass('ywapo_selected');
            ...
            $(this).trigger('yith-wapo-product-option-conditional', $(this).find('input[type="hidden"]'));
            $(this).trigger('yith-wapo-product-option-update');

        });
        //For select
        $(this).on('change', '.ywapo_group_container_select select', function (e) {
            'use strict';
            if ($(this).val() !== '') {
                $(this).addClass('ywapo_selected');
            } else {
            ...
            if ($(this).val() === '' && $(this).parent().parent().parent().parent().find('abbr.required').length) {
                $('.single_add_to_cart_button').removeClass('wc-variation-selection-needed').addClass('disabled wc-variation-is-unavailable');
                $('.woocommerce-variation-add-to-cart').removeClass('woocommerce-variation-add-to-cart-enabled').addClass('woocommerce-variation-add-to-cart-disabled');
            }
        ...
        //For Text field
        $(this).on('change', '.ywapo_input_container_text input[type="text"]', function (e) {
            'use strict';
            if ($(this).val() !== '') {
                $(this).addClass('ywapo_selected');
            } else {
            ...
            if ($(this).val() === '' && $(this).parent().parent().parent().find('abbr.required').length) {
                $('.single_add_to_cart_button').removeClass('wc-variation-selection-needed').addClass('disabled wc-variation-is-unavailable');
                $('.woocommerce-variation-add-to-cart').removeClass('woocommerce-variation-add-to-cart-enabled').addClass('woocommerce-variation-add-to-cart-disabled');
            }
            $(this).trigger('yith-wapo-product-option-conditional', $(this));
            ...
            $cart.find('.ywapo_group_container').each(function () {
                ...
                if (typeof group_container != 'undefined' && !group_container.hasClass('ywapo_conditional_hidden') && !group_container.hasClass('ywapo_conditional_variation_hidden')) {
                    ...
                    if (required && !selected) {
                        ...
                        //group_container.parent().next().find('.single_add_to_cart_button')
                        return;
                    } else {
        ...
        function cechkMinMaxInputValuesAmount(data) {
            ...
            if (current_group_container_type == 'number') {
                ...
                $all_elements.each(function () {
                    var value = $(this).val();
                    if (value != '')
                        $selected_values_amount += parseFloat(value);
                });
