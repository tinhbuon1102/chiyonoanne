...
<div class="order--details__info">
	<h3 class="order--details__number heading heading--xsmall">
		<span class="label"><?php esc_html_e( 'Order Number', 'zoa' ); ?>:</span>
	...
	<div class="order--details__info--half">
		...
		<p class="order--details__date">
			...
			<span class="value"><?php echo wc_get_order_status_name( $order->get_status() ); ?></span>
		</p>
	</div>
	<?php
