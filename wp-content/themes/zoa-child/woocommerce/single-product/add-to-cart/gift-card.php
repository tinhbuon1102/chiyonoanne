...
<form class="gift-cards_form cart" method="post" enctype='multipart/form-data'
	...
	<?php else : ?>
		<div class="gift-cards-list" cellspacing="0" <?php if( ! YITH_YWGC()->frontend->is_manual_amount_allowed ( $product ) && count( $product->get_amounts_to_be_shown()) == 1 ) echo 'style="display: none"'; ?>>
			
			<div class="list-item">
				<span class="label"><label
						for="gift_amounts"><?php echo __( "Amount", 'yith-woocommerce-gift-cards' ); ?></label>
				</span>
				<span class="value ywgc-amount-value">
