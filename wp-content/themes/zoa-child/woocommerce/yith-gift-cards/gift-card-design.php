...
if ( $allow_templates || $allow_customer_images || $allow_use_product_image ) : ?>
	<div class="gift-card-content-editor step-appearance">
        ...
        <div class="field-wrapper">
			<label class="form-row__label light-copy ywgc-editor-section-title">
		...
		<input type="button" class="ywgc-choose-image ywgc-default-picture" value="<?php _e( "Default image", 'yith-woocommerce-gift-cards' ); ?>" />
