...
<div class="row flex-justify-between">
			...
			<?php do_action( 'woocommerce_checkout_before_customer_details' ); ?>
				<div class="order--checkout__form__section legend_wrap">
					<legend class="legend-order--checkout__form__section">
						<h2 class="heading heading--xlarge checkout_heading"><span class="order--checkout__title-break"><?php _e( 'Delivery Details', 'zoa' ); ?></span></h2>
					</legend>
	...
	<?php do_action( 'woocommerce_after_order_notes', $checkout ); ?>
                ...
                </div><!--/order--checkout__footer-->
			</fieldset>
			<fieldset class="step" id="step-2">
				<div class="order--checkout__form__section legend_wrap">
					<legend class="legend-order--checkout__form__section">
						<h2 class="heading heading--xlarge checkout_heading"><span class="order--checkout__title-break"><?php _e( 'Billing Details', 'zoa' ); ?></span></h2>
					</legend>
					<p class="form__description p6"><?php _e( 'Please fill in the information below:', 'zoa' ); ?></p>
				</div>
			<div class="order--checkout--row">
			...
			<fieldset class="step" id="step-3">
				<div class="order--checkout__form__section legend_wrap">
					<legend class="legend-order--checkout__form__section">
						<h2 class="heading heading--xlarge checkout_heading"><span class="order--checkout__title-break"><?php _e( 'Payment', 'zoa' ); ?></span></h2>
					</legend>
				</div>
