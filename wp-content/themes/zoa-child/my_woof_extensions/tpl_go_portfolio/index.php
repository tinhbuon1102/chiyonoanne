...
final class WOOF_EXT_GO_PORTFOLIO extends WOOF_EXT
{

    public $type = 'connector';
    public $folder_name = 'tpl_go_portfolio';
    ...
    public function init()
    {
        ...
        $this->options = array(
            'tpl_folio_id' => array(
                'type' => 'textinput',
                'default' => 'portfolio_bodegas',
                'title' => __('Folio grid template id', 'woocommerce-products-filter'),
                'placeholder' => '',
                'description' => __('Folio shortcode id', 'woocommerce-products-filter')
            )
        );
    }
...
WOOF_EXT::$includes['applications']['tpl_go_portfolio'] = new WOOF_EXT_GO_PORTFOLIO();
