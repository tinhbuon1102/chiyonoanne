 ...
 */
class WooCommerce_Product_Search_Filter_Category_Series_Widget extends WP_Widget {
	 ...
	 * @var string cache id
	 */
	private static $cache_id = 'woocommerce_product_search_filter_category_series_widget';
	...
	public static function init() {
		...
		self::$the_name = __( 'Product Filter &ndash;  series', 'woocommerce-product-search' );
	}
	...
	public static function widgets_init() {
		register_widget( 'WooCommerce_Product_Search_Filter_Category_Series_Widget' );
	}
	...
	public function widget( $args, $instance ) {
		...
		WooCommerce_Product_Search_Filter_Taxonomy_Category::load_resources();
		...
		$output .= WooCommerce_Product_Search_Filter_Taxonomy_Category::render( $instance );
		$output .= $after_widget;
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( empty( $child_of ) ) {
			...
			$term = get_term_by( 'id', $new_instance['child_of'], 'series' );
			if ( $term ) {
				$settings['child_of'] = $term->term_id;
			} else {
				$term = get_term_by( 'slug', $new_instance['child_of'], 'series' );
				if ( $term ) {
					$settings['child_of'] = $term->slug;
				} else {
					$term = get_term_by( 'name', $new_instance['child_of'], 'series' );
					if ( $term ) {
...
WooCommerce_Product_Search_Filter_Category_Series_Widget::init();
