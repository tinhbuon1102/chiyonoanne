...
if( !class_exists('wf_product') ){
	class wf_product{
		...
		public function __construct( $item ){
			$this->wc_version 	= WC()->version;
			$this->obj 			= ( $item instanceof WC_Product ) ? $item : wc_get_product( $item );		// Third party plugin used to modify the product info in cart so we should take the updated data, for eg. - WooCommerce Measurement Price Calculator
