...
if (!is_user_logged_in()) {
    //save session for login case to redirect to step 2
    $_SESSION['ss_date'] = isset($_POST['date']) ? $_POST['date'] : '';
    $_SESSION['ss_title'] = isset($_POST['title']) ? $_POST['title'] : '';
    $_SESSION['ss_timeslot'] = isset($_POST['timeslot']) ? $_POST['timeslot'] : '';
    $_SESSION['ss_calendar_id'] = $_POST['calendar_id'];
}
