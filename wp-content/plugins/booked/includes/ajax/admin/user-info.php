...
?><form action="" method="post" class="booked-form" id="editAppointmentForm" data-appt-id="<?php echo $appt_id; ?>"<?php
if ($calendar_id): echo ' data-calendar-id="' . $calendar_id . '"';
endif;
?>><?php
        ...
        if (!$user_id):
            ...
            $billing_last_name_kana = get_post_meta($appt_id, 'billing_guest_last_name_kana', true);
            $billing_first_name_kana = get_post_meta($appt_id, 'billing_guest_first_name_kana', true);
            $billing_phone = get_post_meta($appt_id, 'billing_guest_phone', true);
        else :
            ...
            $billing_last_name_kana = $user_info->billing_last_name_kana;
    ...
    <?php else: ?>
        ...
        if ($billing_phone):
            ?><div class="field">
                <input value="<?php echo $billing_phone; ?>" placeholder="<?php esc_html_e('Phone Number', 'booked'); ?>..." type="tel" class="large textfield" name="billing_phone" />
            </div><?php
        endif;
