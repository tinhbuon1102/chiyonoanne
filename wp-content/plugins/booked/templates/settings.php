<div class="wrap booked-settings-wrap"><?php
    ...
    if (!current_user_can('manage_booked_options') && $booked_none_assigned):
        ...
        <div id="booked-admin-panel-container">
            ...
            <?php
            $booked_settings_tabs = apply_filters('booked_settings_tabs', array(
                array(
                    'access' => 'admin',
                    'slug' => 'general',
            ...
            foreach ($booked_settings_tabs as $tab_data):
                if ($tab_data['access'] == 'admin' && current_user_can('manage_booked_options') || $tab_data['access'] == 'agent'):
                    if ($tab_counter == 1):
                        ?><ul class="booked-admin-tabs bookedClearFix"><?php endif;
                    ?><li<?php if ($tab_counter == 1): ?> class="active"<?php endif; ?>><a href="#<?php echo $tab_data['slug']; ?>"><?php echo $tab_data['content']; ?><?php if (in_array($tab_data['slug'], $new_items_in_tabs)): booked_new_tag($show_new_tags);
            endif;
                    ?></a></li><?php
                        $tab_counter++;
                    endif;
            ...
            <div class="form-wrapper">
                ...
                foreach ($booked_settings_tabs as $tab_data):
                    ...
                    <?php $section_title = esc_html__('Booking Type', 'booked'); ?>
                                                ...
                                                <?php
                                                $option_name = 'booked_booking_type';
                    ...
                    <?php $selected_value = get_option('booked_registration_name_requirements', array('booked_require_name'));
                    $selected_value = (isset($selected_value[0]) ? $selected_value[0] : false);
                    ?>
                                        <div class="section-row">
                                            <div class="section-head">
                    ...
                    <?php $section_title = esc_html__('Booking Options', 'booked'); ?>
                                                ...
                                                <p style="margin:1.2em 0 10px;">
                                                    <input style="margin:-5px 5px 0 0;" id="booked_require_name" name="booked_registration_name_requirements[]" value="require_name"<?php if (!$selected_value || $selected_value == 'require_name'): echo ' checked="checked"';
                    endif;
                    ?> type="radio">
                                                ...
                                                <p style="margin:0 0 10px;">
                                                    <input style="margin:-5px 5px 0 0;" id="booked_require_surname" name="booked_registration_name_requirements[]" value="require_surname"<?php if ($selected_value == 'require_surname'): echo ' checked="checked"';
                                       endif;
                                       ?> type="radio">
                                        ...
                                        <div class="condition-block booking_type" data-condition-val="guest" style="<?php if ($booking_type == 'guest'): ?>display:block; <?php endif; ?>">
                                            <div class="section-row">
                                                <div class="section-head">
                                                    ...
                                                    <p style="margin:1.2em 0 10px;">
                                                        <input style="margin:-4px 5px 0 0;" id="booked_require_guest_email_address" name="booked_require_guest_email_address" value="true"<?php if ($selected_value): echo ' checked="checked"';
                                           endif;
                                           ?> type="checkbox">
                                        ...
                                        <div class="section-row">
                                            <div class="section-head">
                                                ...
                                                <?php
                                                $option_name = 'booked_appointment_redirect_type';
                                                $selected_value = get_option($option_name, false);
                                                ...
                                                <p style="margin:1.2em 0 10px;"><input style="margin:-4px 5px 0 0;" data-condition="redirect_type" id="redirect_type_none" name="<?php echo $option_name; ?>" value=""<?php if (!$selected_value): echo ' checked="checked"';
                                                endif;
                                                ?> type="radio">
                                                ...
                                                <div class="condition-block booking_type" data-condition-val="registered" style="<?php if ($booking_type == 'registered'): ?>display:block; <?php endif; ?>">
                                                    <p style="margin:0 0 10px;">
                                                        <input style="margin:-4px 5px 0 0;" data-condition="redirect_type" id="redirect_type_detect" name="<?php echo $option_name; ?>" value="booked-profile"<?php if ($selected_value == 'booked-profile'): echo ' checked="checked"';
                                           endif;
                                           ?> type="radio">
                                                ...
                                                <p style="margin:0;">
                                                    <input style="margin:-4px 5px 0 0;" data-condition="redirect_type" id="redirect_type_page" name="<?php echo $option_name; ?>" value="page"<?php if ($selected_value == 'page'): echo ' checked="checked"';
                            endif;
                                                ?> type="radio">
                                                ...
                                                <?php
                                                $option_name = 'booked_appointment_success_redirect_page';
                                        ...
                                        <div class="condition-block booking_type<?php if ($booking_type == 'registered'): ?> default<?php endif; ?>" data-condition-val="registered">
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    ...
                                                    <?php
                                                    $option_name = 'booked_login_redirect_page';
                    ...
                    <?php
                    $option_name = 'booked_custom_login_message';
                    ...
                    ?>
                                        ...
                                        <div class="section-row">
                                            <div class="section-head">
                                                ...
                                                <?php
                                                $option_name = 'booked_timeslot_intervals';
                                        ...
                                        <div class="section-row">
                                            <div class="section-head">
                                                ...
                                                <?php
                                                $option_name = 'booked_appointment_buffer';
                                                $selected_value = get_option($option_name);
                    ...
                    <?php
                    $option_name = 'booked_prevent_appointments_before';
                    $selected_value = get_option($option_name);
                    ?>
                    ...
                    <?php $section_title = esc_html__('Prevent Appointments After Date', 'booked'); ?>
                                                ...
                                                <?php
                                                $option_name = 'booked_prevent_appointments_after';
                                                $selected_value = get_option($option_name);
                                                ?>
                                        ...
                                        <div class="section-row">
                                            <div class="section-head">
                                                ...
                                                <?php
                                                $option_name = 'booked_cancellation_buffer';
                                                $selected_value = get_option($option_name);
                    ...
                    ?>
                                        ...
                                        <div class="section-row">
                                            <div class="section-head">
                                                ...
                                                <?php
                                                $option_name = 'booked_appointment_limit';
                                                $selected_value = get_option($option_name);
                    ...
                    <?php $section_title = esc_html__('New Appointment Default', 'booked'); ?>
                                                ...
                                                <p><?php esc_html_e('Would you like your appointment requests to go into a pending list or should they be approved immediately?', 'booked'); ?></p>
                                                        ...
                                                        <?php
                                                        $option_name = 'booked_new_appointment_default';
                                                        $selected_value = get_option($option_name);
                    ...
                    ?>
                                        ...
                                        <div class="section-row cf">
                                            <div class="section-head">
                                                ...
                                                <?php
                                                $option_name = 'booked_hide_default_calendar';
                                                ...
                                                <?php
                                                $option_name = 'booked_hide_weekends';
                                                $option_value = get_option($option_name, false);
                                                ?>
                                                ...
                                                <?php
                                                $option_name = 'booked_hide_google_link';
                                                $option_value = get_option($option_name, false);
                                                ?>
                                                ...
                                                <?php
                                                $option_name = 'booked_show_only_titles';
                                                $option_value = get_option($option_name, false);
                                                ?>
                    ...
                    <?php
                    $option_name = 'booked_hide_end_times';
                    $option_value = get_option($option_name, false);
                    ?>
                    ...
                    <?php
                    $option_name = 'booked_hide_available_timeslots';
                    $option_value = get_option($option_name, false);
                    ?>
                    ...
                    <?php
                    $option_name = 'booked_hide_unavailable_timeslots';
                    $option_value = get_option($option_name, false);
                    ?>
                    ...
                    <?php
                    $option_name = 'booked_public_appointments';
                    $option_value = get_option($option_name, false);
                    ?>
                    ...
                    <?php
                    $option_name = 'booked_dont_allow_user_cancellations';
                    $option_value = get_option($option_name, false);
                    ?>
                    ...
                    <?php
                    $option_name = 'booked_redirect_non_admins';
                    $option_value = get_option($option_name, false);
                    ?>
                                                ...
                                                <?php
                                                $option_name = 'booked_hide_admin_bar_menu';
                                                $option_value = get_option($option_name, false);
                                                ?>
                    ...
                    <?php
                    $email_template_tabs = apply_filters('booked_admin_email_template_tabs', array(
                    ...
                    <?php
                    $option_name = 'booked_default_email_user';
                    ...
                    <?php $selected_email = get_option('booked_email_force_sender_from', false); ?>
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    ...
                                                    <p style="margin:1.2em 0 15px;">
                                                        <input data-condition="force_sender" style="margin:-4px 5px 0 0;" id="booked_email_force_sender" name="booked_email_force_sender" value="true"<?php if ($selected_value): echo ' checked="checked"';
                                                               endif;
                                                               ?> type="checkbox">
                                                    ...
                                                    <p style="margin:1.2em 0 0;">
                                                        <input style="margin:-4px 5px 0 0;" id="booked_emailer_disabled" name="booked_emailer_disabled" value="true"<?php if ($selected_booked_mailer): echo ' checked="checked"';
                                endif;
                                                               ?> type="checkbox">
                                        ...
                                        <div id="booked-subtab-customer-emails" class="subtab-content">
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_reminder_email';
...
Your friends at ' . get_bloginfo('name');
                                                    ...
                                                    <ul class="cp-list">
                                                    <?php
                                                    $booked_mailer_tokens = booked_mailer_tokens();
                    ...
                    <?php wp_editor($email_content_admin_reminder, $option_name, array('textarea_name' => $option_name, 'media_buttons' => false, 'editor_height' => 250, 'teeny' => true)); ?>
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_registration_email_content';
...
Your friends at ' . get_bloginfo('name');
                                                    ...
                                                    <ul class="cp-list">
                                                        ...
                                                        <li><strong>%kananame%</strong> &mdash; <?php esc_html_e("To display the person's kana name.", "booked"); ?></li><li><strong>%phone%</strong> &mdash; <?php esc_html_e("To display the person's phone.", "booked"); ?></li>													<li><strong>%email%</strong> &mdash; <?php esc_html_e("To display the person's email address.", "booked"); ?></li>
                                            ...
                                            <div class="section-row" data-controller="cp_fes_controller" data-controlled_by="fes_enabled">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_appt_confirmation_email_content';
...
Your friends at ' . get_bloginfo('name');
                                            ...
                                            <div class="section-row" data-controller="cp_fes_controller" data-controlled_by="fes_enabled">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_approval_email_content';
...
Your friends at ' . get_bloginfo('name');
                                            ...
                                            <div class="section-row" data-controller="cp_fes_controller" data-controlled_by="fes_enabled">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_cancellation_email_content';
        ...
        <div>
            ...
            <input type="email" class="field" value="<?php echo $current_booked_another_email_get_notification_value; ?>" name="booked_another_email_get_notification"/>
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_admin_reminder_email';
...
(Sent via the ' . get_bloginfo('name') . ' website)';
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_admin_appointment_email_content';
...
(Sent via the ' . get_bloginfo('name') . ' website)';
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    <?php
                                                    $option_name = 'booked_admin_cancellation_email_content';
...
(Sent via the ' . get_bloginfo('name') . ' website)';
                    ...
                    <?php if (!$booked_none_assigned && count($calendars) >= 1):
                        ...
                        if (current_user_can('manage_booked_options')): echo '<option value="">' . esc_html__('Default Calendar', 'booked') . '</option>';
                        endif;
                                            ...
                                            <div id="customTimeslotsContainer">
                                                ...
                                                if (!empty($booked_custom_timeslots_decoded)):
                                                    ...
                                                    foreach ($custom_timeslots_array as $this_timeslot):
                                                        ...
                                                        ?><div class="booked-customTimeslot"<?php if (!current_user_can('manage_booked_options') && $this_timeslot['booked_custom_calendar_id'] && !in_array($this_timeslot['booked_custom_calendar_id'], $available_calendar_ids)): echo ' style="display:none;"';
                                                        endif;
                                                        ?>>
                                                            ...
                                                            if (!empty($calendars)):
                                                                ...
                                                                if (!current_user_can('manage_booked_options') && $this_timeslot['booked_custom_calendar_id'] && !in_array($this_timeslot['booked_custom_calendar_id'], $available_calendar_ids)):
                                                                    ...
                                                                    if (current_user_can('manage_booked_options')): echo '<option value="">' . __('Default Calendar', 'booked') . '</option>';
                                                                    endif;

                                                                    foreach ($calendars as $calendar):
                                                                        ?><option<?php if ($this_timeslot['booked_custom_calendar_id'] == $calendar->term_id): echo ' selected="selected"';
                                                                        endif;
                                                                        ?> value="<?php echo $calendar->term_id; ?>"><?php echo $calendar->name; ?></option><?php
                                                                    endforeach;
                                                                ...
                                                                ?><input type="hidden" name="booked_custom_calendar_id" value=""><?php endif; ?>
                                                            ...
                                                            <input id="vacationDayCheckbox" name="vacationDayCheckbox" type="checkbox" value="1"<?php if ($this_timeslot['vacationDayCheckbox']): echo ' checked="checked"';
                                endif;
                                                            ?>>
