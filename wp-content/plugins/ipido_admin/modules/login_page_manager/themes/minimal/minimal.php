...
class Ipido_admin_login_theme_Minimal extends Ipido_admin_Login_Theme{
	...
	public function get_settings(){
		...
		$settings 		= array(
			...
			'fields'		=> array(
				...
				array(
					'id'        => $theme_prefix . 'loginbox_background',
					'type'      => 'color_picker',
					'title'     => __('Loginbox Background Color','ipido_admin'),
	...
	function enqueue_scripts(){
		...
		wp_enqueue_style('cs-ipido-admin-google-fonts','https://fonts.googleapis.com/css?family=Maven+Pro', false ); 
	}
