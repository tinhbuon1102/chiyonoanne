...
class Ipido_admin_login_theme_Curvedside extends Ipido_admin_Login_Theme{
		...
		$settings 		= array(
			...
			'fields'		=> array(
				...
				array(
					...
					'type'			=> 'select',
					'title'			=> __('Curved Side Position','ipido_admin'),
					'desc'			=> __('Choose the position','ipido_admin'),
					'options'		=> array(
						'left'	=> __('Left Side','ipido_admin'),
						'right'	=> __('Right Side','ipido_admin'),
					),
					'default'	=> 'left',
				),
				array(
                    ...
                    'type'          => 'background',
                    'title'         => __('Curved Side Background Image','ipido_admin'),
	...
	function enqueue_scripts(){
		...
		wp_enqueue_style('cs-ipido-admin-google-fonts','https://fonts.googleapis.com/css?family=Open+Sans:300,400,700', false ); 
