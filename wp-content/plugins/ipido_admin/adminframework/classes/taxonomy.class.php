...
class CSFramework_Taxonomy extends CSFramework_Abstract{
  ...
  public static function instance( $options = array() ) {
    if ( is_null( self::$instance ) && CSF_ACTIVE_TAXONOMY ) {
  ...
  public function render_taxonomy_form_fields( $term ) {
    ...
    $cs_errors = get_transient( 'csf-taxonomy-transient' );

    wp_nonce_field( 'csf-taxonomy', 'csf-taxonomy-nonce' );

    echo '<div class="csf-framework csf-taxonomy csf-taxonomy-'. $classname .'-fields">';
  ...
  public function save_taxonomy( $term_id ) {
    ...
    if ( wp_verify_nonce( cs_get_var( 'csf-taxonomy-nonce' ), 'csf-taxonomy' ) ) {
