...
class CSFramework_Option_angle extends CSFramework_Options {
	...
	public function output() {
		...
		echo '<div class="csf-anglepicker" data-angle-options=\'' . json_encode( $options ) . '\'>';
        
        echo '
        <div class="csf-field-text_addon"><div class="csf-input-addon-field csf-input-append">
        <input type="text" name="'. $this->element_name() .'" value="'. $this->element_value() .'"'. $this->element_class() . $this->element_attributes() .'/>
        <span class="csf-input-addon">deg</span></div></div>
        ';

        echo '<div class="csf-anglepicker-wrapper"><div class="anglepicker"></div></div>';
