...
class CSFramework_Option_textarea extends CSFramework_Options {
  ...
  public function shortcode_generator() {
    if( isset( $this->field['shortcode'] ) && CSF_ACTIVE_SHORTCODE ) {
      echo '<a href="#" class="button button-primary csf-shortcode csf-shortcode-textarea">'. __( 'Add Shortcode', 'csf-framework' ) .'</a>';
    }
  }
}
