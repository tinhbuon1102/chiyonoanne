...
class CSFramework_Option_builder_detailsview extends CSFramework_Options {
	...
	public function output(){
        ...
        // echo '<div class="csf-layout-builder-ex">';

        echo '
            <div class="csf-uls-layout-builder">
                <div class="csf-uls-layout__design uls-layout-detailsview">
                    <div class="csf-uls-layout-section layout-section__top" data-layout-section="top">'.$parse_value($value_top).'</div>
                    <div class="csf-uls-layout-section layout-section__middle">
                        <div class="csf-uls-layout-section layout-section__left" data-layout-section="left">'.$parse_value($value_left).'</div>
                        <div class="csf-uls-layout-section layout-section__right" data-layout-section="right">'.$parse_value($value_right).'</div>
                    </div>
                    <div class="csf-uls-layout-section layout-section__bottom" data-layout-section="bottom">'.$parse_value($value_bottom).'</div>
                </div>
                <div class="csf-uls-layout__elements">
                    <div class="csf-uls-layout-title">Available Elements</div>
