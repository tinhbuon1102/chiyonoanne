...
class CSFramework_Option_easing_editor extends CSFramework_Options {
	...
	public function output() {
		...
		echo '<div class="csf-easing-editor">';		
		...
		echo csf_add_element( array(
			...
			'class'		=> 'csf-toggle-editor',
			'value'		=> __('Toggle Editor'),
		) );

		echo '<div class="csf-easing-editor__graph-outer-wrapper">';
		
		echo '<div class="csf-easing-editor__graph-wrapper">';
			echo '<div class="csf-easing-editor__graph">';
			echo '<a class="knob p0"></a>';
			echo '<a class="knob p1"></a>';
			echo '<a class="knob p2"></a>';
			echo '<a class="knob p3"></a>';
			echo '<canvas height="200" width="200" class="csf-easing-editor__bezierCurve" />';
			echo '</div>';
		echo '</div>';

		echo '<div class="csf-easing-editor__preview">';
		echo '<div class="csf-easing-editor__preview-box"></div>';
		echo '</div>';

		echo '<div class="csf-easing-editor__result">';
