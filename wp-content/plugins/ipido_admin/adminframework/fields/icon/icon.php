...
class CSFramework_Option_icon extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<a href="#" class="csf-button csf-button-primary csf-icon-add">'. __( 'Add Icon', 'csf-framework' ) .'</a>';
    echo '<a href="#" class="csf-button csf-button-warning csf-icon-remove'. $hidden .'">'. __( 'Remove Icon', 'csf-framework' ) .'</a>';
