...
function woof_redirect_init() {
    try {
        if (jQuery(".woof").length && void 0 !== jQuery(".woof").val())
            return 0 < (woof_redirect = jQuery(".woof").eq(0).data("redirect")).length && (woof_shop_page = woof_current_page_link = woof_redirect),
            woof_redirect
    } catch (e) {
        console.log(e)
    }
...
function woof_init_reset_button() {
    jQuery(".woof_reset_search_form").life("click", function() {
        ...
        woof_is_permalink)
            ...
            woof_current_values.hasOwnProperty("page_id") && (e = location.protocol + "//" + location.host + "/?page_id=" + woof_current_values.page_id,
            woof_current_values = {
                page_id: woof_current_values.page_id
            },
            woof_get_submit_link()),
            woof_submit_link(e),
            woof_is_ajax && (history.pushState({}, "", e),
            woof_current_values.hasOwnProperty("page_id") ? woof_current_values = {
                page_id: woof_current_values.page_id
            } : woof_current_values = {})
        }
        return !1
...
function woof_init_pagination() {
    1 === woof_is_ajax && jQuery("a.page-numbers").life("click", function() {
        var e, o = jQuery(this).attr("href");
        woof_ajax_first_done ? void 0 !== (e = o.split("paged="))[1] ? woof_ajax_page_num = parseInt(e[1]) : woof_ajax_page_num = 1 : void 0 !== (e = o.split("page/"))[1] ? woof_ajax_page_num = parseInt(e[1]) : woof_ajax_page_num = 1;
        return woof_submit_link(woof_get_submit_link()),
        !1
    })
}
...
jQuery(function(e) {
    ...
    jQuery.fn.life = function(e, o, r) {
        return jQuery(this.context).on(e, this.selector, o, r),
        this
    }
    ,
    ...
    jQuery("body").bind("price_slider_change", function(e, o, r) {
        if (woof_autosubmit && !woof_show_price_search_button && jQuery(".price_slider_wrapper").length < 2)
            ...
            woof_current_values.min_price = t,
            woof_current_values.max_price = _
        }
    }),
    jQuery(".woof_price_filter_dropdown").life("change", function() {
        ...
        if (-1 == parseInt(e, 10))
            ...
            e = e.split("-");
            woof_current_values.min_price = e[0],
            woof_current_values.max_price = e[1]
        }
    ...
    jQuery(".woof_price_filter_txt").life("change", function() {
        ...
        o < e || e < 0 ? (delete woof_current_values.min_price,
        delete woof_current_values.max_price) : ("undefined" != typeof woocs_current_currency && (e = Math.ceil(e / parseFloat(woocs_current_currency.rate)),
        o = Math.ceil(o / parseFloat(woocs_current_currency.rate))),
        woof_current_values.min_price = e,
        woof_current_values.max_price = o),
        (woof_autosubmit || 0 == jQuery(this).within(".woof").length) && woof_submit_link(woof_get_submit_link())
    }),
    jQuery(".woof_open_hidden_li_btn").life("click", function() {
        var e = jQuery(this).data("state")
          , o = jQuery(this).data("type");
        return "closed" == e ? (jQuery(this).parents(".woof_list").find(".woof_hidden_term").addClass("woof_hidden_term2"),
        jQuery(this).parents(".woof_list").find(".woof_hidden_term").removeClass("woof_hidden_term"),
        "image" == o ? jQuery(this).find("img").attr("src", jQuery(this).data("opened")) : jQuery(this).html(jQuery(this).data("opened")),
        ...
        "image" == o ? jQuery(this).find("img").attr("src", jQuery(this).data("closed")) : jQuery(this).text(jQuery(this).data("closed")),
    ...
    jQuery(".widget_rating_filter li.wc-layered-nav-rating a").click(function() {
        ...
        e ? delete woof_current_values.min_rating : (woof_current_values.min_rating = r,
    ...
    jQuery(".woof_start_filtering_btn").life("click", function() {
        ...
        jQuery.post(woof_ajaxurl, o, function(e) {
            ...
            jQuery("div.woof_redraw_zone").replaceWith(jQuery(e.form).find(".woof_redraw_zone")),
            woof_mass_reinit()
        }),
        !1
    });
    ...
    window.onpopstate = function(e) {
        try {
            if (Object.keys(woof_current_values).length) {
                ...
                return null == t[1] || t[1].split("#")[0] != r[0] && (woof_show_info_popup(woof_lang_loading),
...
function woof_submit_link(e) {
    if (!woof_submit_link_locked)
        if (woof_submit_link_locked = !0,
        woof_show_info_popup(woof_lang_loading),
        1 !== woof_is_ajax || woof_ajax_redraw)
            if (woof_ajax_redraw) {
                o = {
                    action: "woof_draw_products",
                    link: e,
            ...
            jQuery.post(woof_ajaxurl, o, function(e) {
                e = jQuery.parseJSON(e),
                jQuery(".woof_results_by_ajax_shortcode").length ? jQuery("#woof_results_by_ajax").replaceWith(e.products) : jQuery(".woof_shortcode_output").replaceWith(e.products),
                jQuery("div.woof_redraw_zone").replaceWith(jQuery(e.form).find(".woof_redraw_zone")),
                woof_draw_products_top_panel(),
                woof_mass_reinit(),
                woof_submit_link_locked = !1,
                jQuery.each(jQuery("#woof_results_by_ajax"), function(e, o) {
...
function woof_remove_empty_elements() {
    jQuery.each(jQuery(".woof_container select"), function(e, o) {
        0 === jQuery(o).find("option").size() && jQuery(o).parents(".woof_container").remove()
    }),
    jQuery.each(jQuery("ul.woof_list"), function(e, o) {
        0 === jQuery(o).find("li").size() && jQuery(o).parents(".woof_container").remove()
    })
}
function woof_get_submit_link() {
    if (woof_is_ajax && (woof_current_values.page = woof_ajax_page_num),
    0 < Object.keys(woof_current_values).length && jQuery.each(woof_current_values, function(e, o) {
        e == swoof_search_slug && delete woof_current_values[e],
        "s" == e && delete woof_current_values[e],
        "product" == e && delete woof_current_values[e],
        "really_curr_tax" == e && delete woof_current_values[e]
    }),
    2 === Object.keys(woof_current_values).length && "min_price"in woof_current_values && "max_price"in woof_current_values) {
        ...
        return woof_is_ajax && history.pushState({}, "", e),
        e
    }
    ...
    woof_is_permalink || (0 < woof_redirect.length ? (r = woof_redirect + "?" + swoof_search_slug + "=1",
    woof_current_values.hasOwnProperty("page_id") && delete woof_current_values.page_id) : r = location.protocol + "//" + location.host + "?" + swoof_search_slug + "=1");
    var t = ["path"];
    return 0 < Object.keys(woof_current_values).length && jQuery.each(woof_current_values, function(e, o) {
        "page" == e && woof_is_ajax && (e = "paged"),
        void 0 !== o && (0 < o.length || "number" == typeof o) && -1 == jQuery.inArray(e, t) && (r = r + "&" + e + "=" + o)
    }),
    r = r.replace(new RegExp(/page\/(\d+)\//), ""),
    woof_is_ajax && history.pushState({}, "", r),
    r
}
function woof_show_info_popup(e) {
    if ("default" == woof_overlay_skin)
        jQuery("#woof_html_buffer").text(e),
        jQuery("#woof_html_buffer").fadeTo(200, .9);
    else
...
function woof_draw_products_top_panel() {
    ...
    0 < Object.keys(woof_current_values).length) {
        ...
        jQuery.each(woof_current_values, function(i, e) {
            -1 != jQuery.inArray(i, woof_accept_array) && ("min_price" != i && "max_price" != i || !r) && ("min_price" != i && "max_price" != i || r || (r = !0,
            i = "price",
            e = woof_lang_pricerange),
            (e = e.toString().trim()).search(",") && (e = e.split(",")),
            jQuery.each(e, function(e, r) {
                if ("page" != i && "post_type" != i) {
                    var t = r;
                    if ("orderby" == i)
                        t = void 0 !== woof_lang[r] ? woof_lang.orderby + ": " + woof_lang[r] : woof_lang.orderby + ": " + r;
                    else if ("perpage" == i)
                        t = woof_lang.perpage;
                    else if ("price" == i)
                        t = woof_lang.pricerange;
                    else {
                        var _ = !1;
    ...
    0 != jQuery(o).find("li").size() && jQuery(".woof_products_top_panel").length || o.hide(),
    jQuery(".woof_remove_ppi").parent().click(function() {
        var e = jQuery(this).data("tax")
          , r = jQuery(this).attr("href");
        if ("price" != e) {
            values = woof_current_values[e],
            values = values.split(",");
            var t = [];
            ...
            values = t,
            values.length ? woof_current_values[e] = values.join(",") : delete woof_current_values[e]
        } else
            delete woof_current_values.min_price,
            delete woof_current_values.max_price;
        return woof_ajax_page_num = 1,
        woof_submit_link(woof_get_submit_link()),
        jQuery(".woof_products_top_panel").find("[data-tax='" + e + "'][href='" + r + "']").hide(333),
        !1
    })
}
function woof_shortcode_observer() {
    (jQuery(".woof_shortcode_output").length || "undefined" != typeof woof_not_redirect && 1 == woof_not_redirect) && (woof_current_page_link = location.protocol + "//" + location.host + location.pathname),
...
function woof_init_beauty_scroll() {
    if (woof_use_beauty_scroll)
        try {
            ...
            jQuery("" + e).mCustomScrollbar("destroy"),
...
function woof_init_show_auto_form() {
    ...
    jQuery(".woof_show_auto_form").click(function() {
        return jQuery(this).addClass("woof_hide_auto_form").removeClass("woof_show_auto_form"),
...
function woof_init_hide_auto_form() {
    ...
    jQuery(".woof_hide_auto_form").click(function() {
        return jQuery(this).addClass("woof_show_auto_form").removeClass("woof_hide_auto_form"),
        jQuery(".woof_auto_show").show().animate({
            height: "1px",
            opacity: 0
        }, 377, function() {
...
function woof_checkboxes_slide() {
    if (1 == woof_checkboxes_slide_flag) {
        ...
        e.size() && (jQuery.each(e, function(e, o) {
            if (!jQuery(o).parents(".woof_no_close_childs").length) {
                ...
                if (woof_supports_html5_storage()) {
                    ...
                    jQuery(o).find("input[type=checkbox],input[type=radio]").is(":checked") && (jQuery(o).show(),
                    r = "woof_is_opened"),
                    jQuery(o).before('<a href="javascript:void(0);" class="woof_childs_list_opener"><span class="' + r + '"></span></a>')
            }
        }),
        jQuery.each(jQuery("a.woof_childs_list_opener"), function(e, o) {
            jQuery(o).click(function() {
                ...
                if (e.hasClass("woof_is_closed") ? (jQuery(this).parent().find("ul.woof_childs_list").first().show(333),
                e.removeClass("woof_is_closed"),
                e.addClass("woof_is_opened")) : (jQuery(this).parent().find("ul.woof_childs_list").first().hide(333),
                e.removeClass("woof_is_opened"),
                e.addClass("woof_is_closed")),
        ...
        try {
            jQuery(r).ionRangeSlider({
                ...
                onFinish: function(e) {
                    ...
                    return console.log(o),
                    woof_current_values.min_price = parseInt(e.from, 10) / o,
                    woof_current_values.max_price = parseInt(e.to, 10) / o,
                    "undefined" != typeof woocs_current_currency && (woof_current_values.min_price = Math.ceil(woof_current_values.min_price / parseFloat(woocs_current_currency.rate)),
                    woof_current_values.max_price = Math.ceil(woof_current_values.max_price / parseFloat(woocs_current_currency.rate))),
                    woof_ajax_page_num = 1,
                    (woof_autosubmit || 0 == jQuery(r).within(".woof").length) && woof_submit_link(woof_get_submit_link()),
                    !1
                }
            })
        } catch (e) {}
...
function woof_init_native_woo_price_filter() {
    ...
    jQuery(".widget_price_filter form").submit(function() {
        ...
        return woof_current_values.min_price = e,
        woof_current_values.max_price = o,
        woof_ajax_page_num = 1,
        (woof_autosubmit || 0 == jQuery(input).within(".woof").length) && woof_submit_link(woof_get_submit_link()),
        !1
    })
}
function woof_reinit_native_woo_price_filter() {
    ...
    var e = jQuery(".price_slider_amount #min_price").data("min")
      ...
      , r = parseInt(e, 10)
      , t = parseInt(o, 10);
    woof_current_values.hasOwnProperty("min_price") ? (r = parseInt(woof_current_values.min_price, 10),
    t = parseInt(woof_current_values.max_price, 10)) : (woocommerce_price_slider_params.min_price && (r = parseInt(woocommerce_price_slider_params.min_price, 10)),
    ...
    null == typeof i && (i = woocommerce_price_slider_params.currency_format_symbol),
    jQuery(document.body).bind("price_slider_create price_slider_slide", function(e, o, r) {
        if ("undefined" != typeof woocs_current_currency) {
            var t = o
              , _ = r;
            1 !== woocs_current_currency.rate && (t = Math.ceil(t * parseFloat(woocs_current_currency.rate)),
            _ = Math.ceil(_ * parseFloat(woocs_current_currency.rate))),
            t = woof_front_number_format(t, 2, ".", ","),
            _ = woof_front_number_format(_, 2, ".", ","),
            (jQuery.inArray(woocs_current_currency.name, woocs_array_no_cents) || 1 == woocs_current_currency.hide_cents) && (t = t.replace(".00", ""),
            _ = _.replace(".00", "")),
            "left" === woocs_current_currency.position ? (jQuery(".price_slider_amount span.from").html(i + t),
            jQuery(".price_slider_amount span.to").html(i + _)) : "left_space" === woocs_current_currency.position ? (jQuery(".price_slider_amount span.from").html(i + " " + t),
            jQuery(".price_slider_amount span.to").html(i + " " + _)) : "right" === woocs_current_currency.position ? (jQuery(".price_slider_amount span.from").html(t + i),
            jQuery(".price_slider_amount span.to").html(_ + i)) : "right_space" === woocs_current_currency.position && (jQuery(".price_slider_amount span.from").html(t + " " + i),
            jQuery(".price_slider_amount span.to").html(_ + " " + i))
        } else
            "left" === woocommerce_price_slider_params.currency_pos ? (jQuery(".price_slider_amount span.from").html(i + o),
            jQuery(".price_slider_amount span.to").html(i + r)) : "left_space" === woocommerce_price_slider_params.currency_pos ? (jQuery(".price_slider_amount span.from").html(i + " " + o),
            jQuery(".price_slider_amount span.to").html(i + " " + r)) : "right" === woocommerce_price_slider_params.currency_pos ? (jQuery(".price_slider_amount span.from").html(o + i),
            jQuery(".price_slider_amount span.to").html(r + i)) : "right_space" === woocommerce_price_slider_params.currency_pos && (jQuery(".price_slider_amount span.from").html(o + " " + i),
            jQuery(".price_slider_amount span.to").html(r + " " + i));
    ...
    jQuery(".price_slider").slider({
        ...
        values: [r, t],
        create: function() {
            jQuery(".price_slider_amount #min_price").val(r),
            jQuery(".price_slider_amount #max_price").val(t),
            jQuery(document.body).trigger("price_slider_create", [r, t])
        },
        slide: function(e, o) {
            jQuery("input#min_price").val(o.values[0]),
            jQuery("input#max_price").val(o.values[1]),
            jQuery(document.body).trigger("price_slider_slide", [o.values[0], o.values[1]])
        },
        change: function(e, o) {
...
function woof_init_toggles() {
    jQuery(".woof_front_toggle").life("click", function() {
        return "opened" == jQuery(this).data("condition") ? (jQuery(this).removeClass("woof_front_toggle_opened"),
...
function woof_price_filter_radio_init() {
    "none" != icheck_skin ? (jQuery(".woof_price_filter_radio").iCheck("destroy"),
    jQuery(".woof_price_filter_radio").iCheck({
        radioClass: "iradio_" + icheck_skin.skin + "-" + icheck_skin.color
    }),
    jQuery(".woof_price_filter_radio").siblings("div").removeClass("checked"),
    jQuery(".woof_price_filter_radio").unbind("ifChecked"),
    jQuery(".woof_price_filter_radio").on("ifChecked", function(e) {
        ...
        if (-1 == parseInt(o, 10))
            ...
            o = o.split("-");
            woof_current_values.min_price = o[0],
            woof_current_values.max_price = o[1],
...
function woof_infinite() {
    if ("undefined" != typeof yith_infs) {
        ...
        if (null != o[1]) {
            ...
            delete t.paged,
            r = decodeURIComponent(jQuery.param(t))
        }
        ...
        _ = o[0] + n + "?" + r,
        jQuery(".woocommerce-pagination li .next").attr("href", _),
...
function woof_change_link_addtocart() {
    woof_is_ajax && jQuery(".add_to_cart_button").each(function(e, o) {
        ...
        null != t[1] && (r = _[0] + "?" + t[1],
        jQuery(o).attr("href", r))
    })
}
function woof_front_number_format(e, o, r, t) {
    e = (e + "").replace(/[^0-9+\-Ee.]/g, "");
    var _, i, n, a = isFinite(+e) ? +e : 0, s = isFinite(+o) ? Math.abs(o) : 0, c = void 0 === t ? "," : t, u = void 0 === r ? "." : r, f = "";
    return 3 < (f = (s ? (_ = a,
    i = s,
    n = Math.pow(10, i),
    "" + (Math.round(_ * n) / n).toFixed(i)) : "" + Math.round(a)).split("."))[0].length && (f[0] = f[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, c)),
    (f[1] || "").length < s && (f[1] = f[1] || "",
...
function woof_init_checkboxes() {
    "none" != icheck_skin ? (jQuery(".woof_checkbox_term").iCheck("destroy"),
    ...
    jQuery("label.woof_checkbox_label").click(function() {
        return jQuery(this).prev().find(".woof_checkbox_term").is(":checked") ? (jQuery(this).prev().find(".woof_checkbox_term").trigger("ifUnchecked"),
...
function woof_checkbox_direct_search(e, r, o, t) {
    var _ = ""
      , i = !0;
    if (t)
        o && o in woof_current_values ? woof_current_values[o] = woof_current_values[o] + "," + r : woof_current_values[o] = r,
        i = !0;
    else {
        ...
        (_ = n).length ? woof_current_values[o] = _.join(",") : delete woof_current_values[o],
        i = !1
    }
    jQuery(".woof_checkbox_term_" + e).attr("checked", i),
    woof_ajax_page_num = 1,
    woof_autosubmit && woof_submit_link(woof_get_submit_link())
}
function woof_init_mselects() {
    ...
    jQuery(".woof_mselect").change(function(e) {
        ...
        if (is_woof_use_chosen) {
            ...
            jQuery(".woof_mselect[name=" + r + "] option:selected").removeAttr("selected"),
            jQuery(".woof_mselect[name=" + r + "] option").each(function(e, o) {
                var r = jQuery(this).val();
                -1 !== jQuery.inArray(r, t) && jQuery(this).prop("selected", !0)
            })
        }
        return woof_mselect_direct_search(r, o),
        !0
    })
}
function woof_mselect_direct_search(e, o) {
    ...
    })).join(",")).length ? woof_current_values[e] = r : delete woof_current_values[e],
    woof_ajax_page_num = 1,
    woof_autosubmit && woof_submit_link(woof_get_submit_link())
}
function woof_init_radios() {
    "none" != icheck_skin ? (jQuery(".woof_radio_term").iCheck("destroy"),
    jQuery(".woof_radio_term").iCheck({
        radioClass: "iradio_" + icheck_skin.skin + "-" + icheck_skin.color
    }),
    jQuery(".woof_radio_term").unbind("ifChecked"),
    jQuery(".woof_radio_term").on("ifChecked", function(e) {
        jQuery(this).attr("checked", !0),
...
function woof_radio_direct_search(e, r, o) {
    ...
    0 != o ? (woof_current_values[r] = o,
    jQuery("a.woof_radio_term_reset_" + e).hide(),
    jQuery("woof_radio_term_" + e).filter(":checked").parents("li").find("a.woof_radio_term_reset").show(),
    jQuery("woof_radio_term_" + e).parents("ul.woof_list").find("label").css({
        fontWeight: "normal"
    }),
    jQuery("woof_radio_term_" + e).filter(":checked").parents("li").find("label.woof_radio_label_" + o).css({
        fontWeight: "bold"
    })) : (jQuery("a.woof_radio_term_reset_" + e).hide(),
    jQuery("woof_radio_term_" + e).attr("checked", !1),
    jQuery("woof_radio_term_" + e).parent().removeClass("checked"),
    jQuery("woof_radio_term_" + e).parents("ul.woof_list").find("label").css({
        fontWeight: "normal"
    })),
    woof_ajax_page_num = 1,
...
function woof_select_direct_search(e, r, o) {
    ...
    0 != o && (woof_current_values[r] = o),
    woof_ajax_page_num = 1,
    (woof_autosubmit || 0 == jQuery(e).within(".woof").length) && woof_submit_link(woof_get_submit_link())
}
