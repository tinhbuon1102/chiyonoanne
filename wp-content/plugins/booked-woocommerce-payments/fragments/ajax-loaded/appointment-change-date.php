	...
	<form action="" method="post" id="newAppointmentForm" data-calendar-id="<?php echo $calendar_id; ?>">
		...
		<div class="booked-appointments">
			<div class="booked-appointment-details">
				<p class="appointment-info"><i class="booked-icon booked-icon-calendar"></i>&nbsp;&nbsp;&nbsp;<?php echo sprintf( esc_html__( '%s at %s','booked-woocommerce-payments' ), $appt_date_name, $appt_timeslot ); ?></p>
			</div>
		</div>
