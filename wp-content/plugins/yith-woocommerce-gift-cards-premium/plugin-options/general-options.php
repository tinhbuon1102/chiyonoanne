...
$general_options = array(
	...
	'general' => array(
        ...
        'ywgc_date_format_option' => array(
            'name'    => __( 'Date format', 'yith-woocommerce-gift-cards' ),
            'type'    => 'select',
            'id'      => 'ywgc_date_format_option',
            'desc'    => __( 'Choose the plugin date format', 'yith-woocommerce-gift-cards' ),
            'options' => array(
                'y_m_d' => __( 'Year/Month/Day', 'yith-woocommerce-gift-cards' ),
                'd_m_y' => __( 'Day/Month/Year', 'yith-woocommerce-gift-cards' ),
            ),
            'default' => 'y_m_d',
        ),
        ...
        'ywgc_auto_discount_button_activation'          => array(
            'name'    => __( 'Enable email button', 'yith-woocommerce-gift-cards' ),
            'type'    => 'checkbox',
            'id'      => 'ywgc_auto_discount_button_activation',
            'desc'    => __( 'Display email button', 'yith-woocommerce-gift-cards' ),
            'default' => 'yes',
        ),
        'ywgc_auto_discount_button_activation_desc' => array(
            'type'             => 'yith-field',
            'yith-type'        => 'html',
            'yith-display-row' => true,
            'html'             => "<span class='yith_wc_gift_card_admin_menu_additional_description' style='margin-top: -15px;'>" . __( 'If you enable this option, a button will be displayed on the gift card email sent. Set the configuration of this button with the next three below options.', 'yith-woocommerce-gift-cards' ),
        ),
        ...
        'ywgc_email_button_redirect'                    => array(
            'name'    => __( 'Email button redirect', 'yith-woocommerce-gift-cards' ),
            'type'    => 'radio',
            'id'      => 'ywgc_email_button_redirect',
            'options' => array(
                'home_page'     => __( "Home page", 'yith-woocommerce-gift-cards' ),
                'customize_page'   => __( "Choose a page", 'yith-woocommerce-gift-cards' ),
            ),
            'default' => 'home_page',
        ),
