        ...
        public function yith_ywgc_transform_smart_coupons_buttons(){
            ...
            if ( class_exists( 'WC_Smart_Coupons' ) ) {
                ...
                <tr id="ywgc_ajax_zone_transform_smart_coupons">
                    <td width="20%">
                        <ul>
                            <li><strong><?php esc_html_e( 'Transfer Smart Coupons to YITH Gift Cards ', 'yith-woocommerce-gift-card' );?></strong></li>
                        </ul>
                    </td>
                    <td>
                        <ul>
                            <li><label><a class="ywgc_transform_smart_coupons_class button" id="yith_ywgc_transform_smart_coupons" >Transfer</a></label><?php echo wc_help_tip( __( 'This will transfer your Smart Coupons to Gift Cards', 'yith-woocommerce-gift-card' ) ); ?></li>
                        </ul>
