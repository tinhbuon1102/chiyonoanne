...
if ( ! class_exists ( 'YITH_WooCommerce_Gift_Cards_Premium' ) ) {
	...
	class YITH_WooCommerce_Gift_Cards_Premium extends YITH_WooCommerce_Gift_Cards {
        ...
        public function yith_ywgc_date_format_callback( $date_format ) {
		    ...
		    if ( get_option( "ywgc_date_format_option" ) == 'y_m_d' ) {
                $date_format = 'Y-m-d';
            }
            if ( get_option( "ywgc_date_format_option" ) == 'd_m_y' ) {
                $date_format = 'd-m-Y';
            }
		...
		public function init_plugin() {
            ...
            $get_option_ywgc_gift_this_product_label = get_option ( 'ywgc_gift_this_product_label' );
            $this->ywgc_gift_this_product_label    = ( empty( $get_option_ywgc_gift_this_product_label ) ? 'Gift this product' : $get_option_ywgc_gift_this_product_label );
