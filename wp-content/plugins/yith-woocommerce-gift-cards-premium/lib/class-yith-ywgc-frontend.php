	...
	class YITH_YWGC_Frontend {
        ...
        public function frontend_init() {
            ...
            if ( get_option( 'ywgc_gift_card_form_on_cart' ) != 'no' ){
                ...
                $get_option_ywgc_gift_card_form_on_cart_place = get_option ( 'ywgc_gift_card_form_on_cart_place' );
            ...
            if ( get_option( 'ywgc_gift_card_form_on_checkout' ) != 'no' ){
                ...
                $get_option_ywgc_gift_card_form_on_checkout_place = get_option ( 'ywgc_gift_card_form_on_checkout_place' );
