;(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ( typeof(ywgc_data) !== 'undefined' && ywgc_data.date_format == 'Y-m-d' ){
            var date_format = 'yy-mm-dd';
        }
        if ( typeof(ywgc_data) !== 'undefined' && ywgc_data.date_format == 'd-m-Y' ){
    ...
    if ( typeof(ywgc_data) !== 'undefined' && ywgc_data.gift_amounts_select2 == 'yes' )
