jQuery(document).ready(function ($) {
    ...
    var trigger_brightness_args = [
        ...
        {
            'trigger'        :'#ywgc_auto_discount_button_activation',
            'hide_when'      :'no_checked',
            'type'           :'checkbox',
            'elements'       :[ '#ywgc_gift_this_product_label',
                '#ywgc_auto_discount',
                '#ywgc_email_button_redirect',
                '#ywgc_email_button_label',
                'input:radio[name=ywgc_email_button_redirect]',
                '#select2-ywgc_redirected_page-container' ],
            'dependencies'   :[ 'input:radio[name=ywgc_email_button_redirect]' ],
        },
        {
            'trigger'        :'input:radio[name=ywgc_email_button_redirect]',
            'show_when'      :'customize_page',
            'type'           :'radio',
            'elements'       :[ '#select2-ywgc_redirected_page-container' ],
            'dependencies'   :[],
        },
    ];
