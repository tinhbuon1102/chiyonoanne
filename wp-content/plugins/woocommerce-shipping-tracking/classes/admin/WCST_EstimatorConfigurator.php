...
class WCST_EstimatorConfigurator
{
		...
		if( function_exists('acf_add_options_page') ) 
		{
			/*acf_add_options_page(array(
			 ...
			 acf_add_options_sub_page(array(
				'page_title' 	=> 'Estimated shipping for products',
				'menu_title'	=> 'Estimated shipping for products',
	...
	function cl_set_global_options_pages($current_screen) 
	{
	  ...
	  $page_ids = array(
		...
		"shipping-tracking_page_acf-options-estimated-shipping-for-products"
	  );
	  //wcst_var_dump($current_screen->id);
