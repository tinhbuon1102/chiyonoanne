<?php 
	//$wcst_time_model->format_data($delivery_info['date_start_range']) 
	if(isset($delivery_info['date_start_range']) && $delivery_info['date_start_range']!="")
	{
		?>
			...
			<span>
				...
				<?php if(isset($delivery_info['date_end_range']) && $delivery_info['date_end_range'] != "") echo __('To: ','woocommerce-shipping-tracking').$delivery_info['date_end_range']; ?><br/>
			</span>			
		<?php
	}
