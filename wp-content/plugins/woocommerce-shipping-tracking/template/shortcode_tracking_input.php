...
<div id="wcst_tracking_form_<?php echo $unique_id; ?>" class="wcst_tracking_form">
	...
	<input type="text" class="wcst_tracking_code_input" id="wcst_tracking_code_input_<?php echo $unique_id; ?>" value="<?php echo $tracking_code; ?>"></input>
...
<div id="wcst_tracking_info_box_<?php echo $unique_id; ?>" class="wcst_tracking_info_box_in_site"></div>
