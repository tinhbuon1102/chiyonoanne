<script>
	var wcst_delivery_min_day = <?php echo $min_date['day']; ?>;
	var wcst_delivery_min_month = <?php echo $min_date['month']; ?>;
	var wcst_delivery_min_year = <?php echo $min_date['year']; ?>;
...
<?php 
	...
	$render_save_button = /* $allow_re_edit || */
