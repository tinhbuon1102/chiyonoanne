...
class QuadMenu_Nav_Menu_Column extends QuadMenu_Settings {
  ...
  public function columns($menu_obj, $menu_id = 0) {
    ...
    $w4 = array(
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-4')),
    );

    $w12 = array(
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-12')),
    );

    $w6w6 = array(
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-6')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-6')),
    );
    ...
    $w3w3w3w3 = array(
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-3')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-3')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-3')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-3')),
    );
    ...
    $w2w2w2w2w2w2 = array(
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-2')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-2')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-2')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-2')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-2')),
    ...
    $w4w8 = array(
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-4')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-8')),
    );
    ...
    $w2w10 = array(
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-2')),
        array('quadmenu' => 'column', 'columns' => array('col-xs-12', 'col-sm-10')),
    );
